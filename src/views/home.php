<main class="">
    <header class="bg-cover relative min-h-screen grid place-items-center">
        ...
        <div class=" absolute z-20">
            <h1
                class="text-5xl sm:text-7xl text-center text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">
                Roulez sans limite, <br> réservez en un clic
            </h1>
            <form action="/src/utils/process.php" method="post"
                class="bg-white p-3 flex flex-col gap-4 rounded-md shadow-md m-4 max-w-[30rem]">
                <div class="">
                    <h4 class="text-lg text-center">Sélectionnez le type de véhicule</h4>
                    <div class="flex flex-wrap gap-2">
                        <label for="sans-permis" class="relative flex flex-col justify-center gap-2">
                        ...
                        <label for="citadine" class="relative flex flex-col justify-center gap-2">
                        ...
                        <label for="berline" class="relative flex flex-col justify-center gap-2">
                        ...
                        <label for="suv" class="relative flex flex-col justify-center gap-2">
                        ...
                        <label for="sportive" class="relative flex flex-col justify-center gap-2">
                        ...
                        <label for="camion" class="relative flex flex-col justify-center gap-2">
                ...
                <div class="flex gap-2 align-items-center justify-center w-full">
                    <div class="flex flex-col">
                        ...
                        <input type="datetime-local" name="debut" id="debut"
                            class="focus:outline-none border-none rounded-sm p-1 text-base">
                    </div>
                    <div class="flex flex-col">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="identite" id="identite"
                        class="bg-slate-100 focus:bg-slate-50 focus:outline-none border rounded-sm p-1 text-base">
                </div>
                ...
                <button type="submit"
                    class="bg-gradient-to-r from-red-600 to-amber-600 text-white px-4 py-2 rounded-sm shadow-md">
